...
public class Users {
    ...
    int id, num_tel;
    String email, password, name , surname, stripID;

    public Users(int id, int num_tel, String email, String password, String name, String surname, String stripeID) {
        this.id = id;
